...
void NiagaraScript_485_Func_(int In_SourceSpace, int In_DestinationSpace, float4x4 In_LocalToWorldTransform, float4x4 In_WorldToLocalTransform, bool In_bLocalSpace, out bool Out_bUseOriginal, out float4x4 Out_OutTransform, out bool Out_LocalToWorld, inout FSimulationContext Context);
void NiagaraScript_484_Emitter_Localspace_false_Particle_Func_(float3 In_Position, int In_SourceSpace, int In_DestinationSpace, bool In_ApplyScale, float4x4 In_Engine_Owner_SystemLocalToWorld, float4x4 In_Engine_Owner_SystemWorldToLocal, float4x4 In_Engine_Owner_SystemLocalToWorldNoScale, float4x4 In_Engine_Owner_SystemWorldToLocalNoScale, out float3 Out_Position, inout FSimulationContext Context);
...
void NiagaraScript_448_Particle_Func_(float3 In_V, float3 In_Fallback, float In_Threshold, out float3 Out_Direction, out float Out_Length, out bool Out_BelowThreshold, inout FSimulationContext Context);
...
void NiagaraScript_474_Func_(float In_dt, float In_DissipationRate, float2 In_Vector2DValue, out float2 Out_DissipatedVector2D, inout FSimulationContext Context);
...
void NiagaraScript_481_Func_(out int Out_IterationIndex, out int Out_MaxIterations, out float Out_NormalizedIterationIndex, out int Out_LoopIndex, out int Out_NumberOfLoops, out float Out_NormalizedLoopIndex, inout FSimulationContext Context);
...
void NiagaraScript_466_Func_(float In_dt, float In_DissipationRate, float In_SubtractionAmount, float In_FloatValue, out float Out_DissipatedFloat, inout FSimulationContext Context);
...
void NiagaraScript_471_Particle_Func_(float4 In_FLOAT4_VAR, int In_TargetChannel, out float Out_NewOutput, inout FSimulationContext Context);
...
void NiagaraScript_490_Particle_Func_(float3 In_VECTOR_VAR, int In_TargetChannel, out float Out_Float, inout FSimulationContext Context);
...
bool NiagaraScript_485_Func_Output_bUseOriginal;
float4x4 NiagaraScript_485_Func_Output_OutTransform;
bool NiagaraScript_485_Func_Output_LocalToWorld;
NiagaraScript_485_Func_(In_SourceSpace, In_DestinationSpace, LocalToWorld_SelectResult, WorldToLocal_SelectResult, Constant29, NiagaraScript_485_Func_Output_bUseOriginal, NiagaraScript_485_Func_Output_OutTransform, NiagaraScript_485_Func_Output_LocalToWorld, Context);
float3 Result35 = mul(float4(In_Position,1.0),NiagaraScript_485_Func_Output_OutTransform).xyz;
...
float3 NiagaraScript_484_Emitter_Localspace_false_Particle_Func_Output_Position;
NiagaraScript_484_Emitter_Localspace_false_Particle_Func_(GetPositionByIndex_Emitter_ParticleSource_AttributePositionOutput_Value, Constant19, Constant20, Constant21, Constant22, Constant23, Constant24, Constant25, NiagaraScript_484_Emitter_Localspace_false_Particle_Func_Output_Position, Context);
float3 Constant37 = float3(0.0, 0.0, 0.0);
float3 NiagaraPosition_SelectResult2 = Constant37;
NiagaraPosition_SelectResult2 = NiagaraScript_484_Emitter_Localspace_false_Particle_Func_Output_Position;
...
float Constant38 = 1;
float Result40 = Context.MapSimStage3_RasterizeSourceParticles.Grid2D_Gas_ParticleScatterSource.DensityMult * Constant38;
float Result41 = Context.MapSimStage3_RasterizeSourceParticles.Grid2D_Gas_ParticleScatterSource.TemperatureMult * Constant38;
...
float2 Result45 = Context.MapSimStage4_PreSim.Transient.PhysicsForce + CustomHlsl8CDC34A240CCEF9AD50A839D76D054C2_Func_Output_VC_Force;
Context.MapSimStage4_PreSim.Transient.PhysicsForce = Result45;
float Constant52 = 1;
float Result46 = Constant52 * Context.MapSimStage4_PreSim.Multiply_Float001.B;
Out_Result = Result46;
float Constant54 = -1;
float Result47 = Constant54 * Context.MapSimStage4_PreSim.Multiply_Float008.B;
Out_Result = Result47;
...
float3 Result48 = Context.MapSimStage4_PreSim.Transient.PhysicsForceWorld + CustomHlsl1EDF8AC24F9709F796E9D0870D247FFC_Func_Output_Force;
...
float Result49 = Context.MapSimStage4_PreSim.Engine.Time * Constant61;
float2 TurbulenceForce1A920C854570890F49C6B6A4BE8A966C_Func_Output_TurbulenceForce;
TurbulenceForce1A920C854570890F49C6B6A4BE8A966C_Func_(Constant59, Constant60, UnitToSimulation_Emitter_SimGridOutput_Simulation, Result49, TurbulenceForce1A920C854570890F49C6B6A4BE8A966C_Func_Output_TurbulenceForce);
float2 Result50 = TurbulenceForce1A920C854570890F49C6B6A4BE8A966C_Func_Output_TurbulenceForce + Context.MapSimStage4_PreSim.Transient.PhysicsForce;
...
float3 NiagaraScript_448_Particle_Func_Output_Direction;
float NiagaraScript_448_Particle_Func_Output_Length;
bool NiagaraScript_448_Particle_Func_Output_BelowThreshold;
NiagaraScript_448_Particle_Func_(Constant65, Constant68, Constant69, NiagaraScript_448_Particle_Func_Output_Direction, NiagaraScript_448_Particle_Func_Output_Length, NiagaraScript_448_Particle_Func_Output_BelowThreshold, Context);
float3 Result59 = mul(float4(NiagaraScript_448_Particle_Func_Output_Direction,0.0),Context.MapSimStage4_PreSim.Grid2D_WindForce.WorldToLocal).xyz;
float2 WindForce5644C4204BEF67FC22121D96EC483B74_Func_Output_WindForce2D;
WindForce5644C4204BEF67FC22121D96EC483B74_Func_(Result51, Result59, Context.MapSimStage4_PreSim.Grid2D_WindForce.dx, Constant66, WindForce5644C4204BEF67FC22121D96EC483B74_Func_Output_WindForce2D);
float2 Result60 = WindForce5644C4204BEF67FC22121D96EC483B74_Func_Output_WindForce2D + Context.MapSimStage4_PreSim.Transient.PhysicsForce;
...
int Constant77 = 1;
int Result67 = Context.MapSimStage5_AdvectVelocity.Add_Integer001.A + Constant77;
...
float Constant82 = 1;
float Result70 = Result69 + Constant82;
float2 Result71 = In_Vector2DValue / Result70;
Out_DissipatedVector2D = Result71;
float2 NiagaraScript_474_Func_Output_DissipatedVector2D;
NiagaraScript_474_Func_(Context.MapSimStage5_AdvectVelocity.DissipateVector2D.dt, Context.MapSimStage5_AdvectVelocity.DissipateVector2D.DissipationRate, Context.MapSimStage5_AdvectVelocity.DissipateVector2D.VectorValue, NiagaraScript_474_Func_Output_DissipatedVector2D, Context);
Context.MapSimStage5_AdvectVelocity.OUTPUT_VAR.DissipateVector2D.DissipatedVector2D = NiagaraScript_474_Func_Output_DissipatedVector2D;
...
int NiagaraScript_481_Func_Output_IterationIndex;
int NiagaraScript_481_Func_Output_MaxIterations;
float NiagaraScript_481_Func_Output_NormalizedIterationIndex;
int NiagaraScript_481_Func_Output_LoopIndex;
int NiagaraScript_481_Func_Output_NumberOfLoops;
float NiagaraScript_481_Func_Output_NormalizedLoopIndex;
NiagaraScript_481_Func_(NiagaraScript_481_Func_Output_IterationIndex, NiagaraScript_481_Func_Output_MaxIterations, NiagaraScript_481_Func_Output_NormalizedIterationIndex, NiagaraScript_481_Func_Output_LoopIndex, NiagaraScript_481_Func_Output_NumberOfLoops, NiagaraScript_481_Func_Output_NormalizedLoopIndex, Context);
...
float Result76 = PI;
CustomHlsl001F9A457414CBA84D93D4B4DA770487137Emitter_PressureGrid_Func_(Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.dx, Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.Inverse, Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.XDirecton, GetGroupID2704B67B4073AF1256539E9A763D1533_Func_Output_GroupID3, GetGroupID2704B67B4073AF1256539E9A763D1533_Func_Output_GroupThreadID3, Result76, Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.bPoissonSolver, Context);
...
CustomHlsl3293810643037FF6C04BFFA7C0F414DFEmitter_SimGrid_Func_(Result79, ExecutionIndexToGridIndex_Emitter_SimGridOutput_IndexX3, ExecutionIndexToGridIndex_Emitter_SimGridOutput_IndexY3, Context.MapSimStage12_ProjectPressure.Emitter.SimGrid.Boundary, Constant113, Constant114, Constant115, Constant116, Constant117, Constant118, CustomHlsl3293810643037FF6C04BFFA7C0F414DFEmitter_SimGrid_Func_Output_VelocityOut);
...
float Constant129 = 1;
float Result83 = Result82 + Constant129;
float Result84 = In_FloatValue / Result83;
float Result85 = In_SubtractionAmount * In_dt;
float Result86 = Result84 - Result85;
float Constant130 = 0;
float Constant131 = 1e+09;
float Result87 = clamp(Result86,Constant130,Constant131);
Out_DissipatedFloat = Result87;
float Constant128 = 0;
float NiagaraScript_466_Func_Output_DissipatedFloat;
NiagaraScript_466_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat.dt, Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat.DissipationRate, Constant128, Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat.FloatValue, NiagaraScript_466_Func_Output_DissipatedFloat, Context);
Context.MapSimStage13_AdvectScalarsandPostSim.OUTPUT_VAR.DissipateFloat.DissipatedFloat = NiagaraScript_466_Func_Output_DissipatedFloat;
float Constant133 = 0;
float NiagaraScript_466_Func_Output_DissipatedFloat1;
NiagaraScript_466_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat001.dt, Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat001.DissipationRate, Constant133, Context.MapSimStage13_AdvectScalarsandPostSim.DissipateFloat001.FloatValue, NiagaraScript_466_Func_Output_DissipatedFloat1, Context);
Context.MapSimStage13_AdvectScalarsandPostSim.OUTPUT_VAR.DissipateFloat001.DissipatedFloat = NiagaraScript_466_Func_Output_DissipatedFloat1;
...
CustomHlsl706BA85C45F835B37A92EC888733867AEmitter_SimGrid_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectVector4.VelocityIndex, Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectVector4.dx, Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectVector4.dt, LinearToIndex_Emitter_SimGridOutput_IndexX4, LinearToIndex_Emitter_SimGridOutput_IndexY4, Constant135, Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectVector4.AttributeIndex, CustomHlsl706BA85C45F835B37A92EC888733867AEmitter_SimGrid_Func_Output_AdvectedVector4);
Context.MapSimStage13_AdvectScalarsandPostSim.OUTPUT_VAR.Grid2D_AdvectVector4.AdvectedVector4 = CustomHlsl706BA85C45F835B37A92EC888733867AEmitter_SimGrid_Func_Output_AdvectedVector4;
...
bool Result89 = NiagaraAll(W1 < Constant136);
float3 Output110;
Output110.x = X1;
Output110.y = Y1;
Output110.z = Z1;
...
float3 RGB_SelectResult5 = Constant137;
...
float NiagaraFloat_SelectResult6 = Constant142;
...
float NiagaraScript_471_Particle_Func_Output_NewOutput;
NiagaraScript_471_Particle_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4.Vector4, Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput, Context);
Out_Float = NiagaraScript_471_Particle_Func_Output_NewOutput;
float NiagaraScript_471_Particle_Func_Output_NewOutput1;
NiagaraScript_471_Particle_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4001.Vector4, Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4001.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput1, Context);
Out_Float = NiagaraScript_471_Particle_Func_Output_NewOutput1;
float NiagaraScript_471_Particle_Func_Output_NewOutput2;
NiagaraScript_471_Particle_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4003.Vector4, Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4003.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput2, Context);
Out_Float = NiagaraScript_471_Particle_Func_Output_NewOutput2;
float NiagaraScript_471_Particle_Func_Output_NewOutput3;
NiagaraScript_471_Particle_Func_(Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4002.Vector4, Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4002.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput3, Context);
Out_Float = NiagaraScript_471_Particle_Func_Output_NewOutput3;
...
float Constant149 = 1;
float4 Result92 = Result91 * Constant149;
float X5;
float Y5;
float Z5;
float W3;
...
float Constant155 = 1;
float4 Result95 = Result94 * Constant155;
float X7;
float Y7;
float Z7;
float W4;
...
float NiagaraFloat_SelectResult7 = Constant161;
...
float NiagaraScript_490_Particle_Func_Output_Float;
NiagaraScript_490_Particle_Func_(Context.MapSimStage15_ComputeLighting.MakeFloatFromVector.VECTOR_VAR, Context.MapSimStage15_ComputeLighting.MakeFloatFromVector.Channel, NiagaraScript_490_Particle_Func_Output_Float, Context);
Out_Float = NiagaraScript_490_Particle_Func_Output_Float;
float NiagaraScript_490_Particle_Func_Output_Float1;
NiagaraScript_490_Particle_Func_(Context.MapSimStage15_ComputeLighting.MakeFloatFromVector001.VECTOR_VAR, Context.MapSimStage15_ComputeLighting.MakeFloatFromVector001.Channel, NiagaraScript_490_Particle_Func_Output_Float1, Context);
Out_Float = NiagaraScript_490_Particle_Func_Output_Float1;
float NiagaraScript_490_Particle_Func_Output_Float2;
NiagaraScript_490_Particle_Func_(Context.MapSimStage15_ComputeLighting.MakeFloatFromVector002.VECTOR_VAR, Context.MapSimStage15_ComputeLighting.MakeFloatFromVector002.Channel, NiagaraScript_490_Particle_Func_Output_Float2, Context);
Out_Float = NiagaraScript_490_Particle_Func_Output_Float2;
float Constant164 = 0;
...
Context.MapSimStage4_PreSim.ComputeBoundaryGrid2D.UseSolidVelocity = Constant40;
Context.MapSimStage4_PreSim.ComputeBoundaryGrid2D.UseGBufferVelocity = Constant41;
Context.MapSimStage4_PreSim.ComputeBoundaryGrid2D.OpenBoundaryRight = Constant42;
Context.MapSimStage4_PreSim.ComputeBoundaryGrid2D.OpenBoundaryDown = Constant43;
Context.MapSimStage4_PreSim.ComputeBoundaryGrid2D.OpenBoundaryLeft = Constant44;
float Constant45 = 1;
...
Context.MapSimStage4_PreSim.Transient.PhysicsForce = Constant50;
...
Context.MapSimStage4_PreSim.Transient.PhysicsForceWorld = Constant55;
...
float3 Constant63 = float3(1,1,0);
float Constant64 = 0;
...
Context.MapSimStage5_AdvectVelocity.Grid2D_AdvectScalar.InterpolationMethod = Constant72;
float Constant73 = 1;
...
Context.MapSimStage5_AdvectVelocity.Grid2D_AdvectScalar001.InterpolationMethod = Constant78;
float Constant79 = 1;
...
int Constant83 = 1;
int Constant84 = 0;
Context.MapSimStage5_AdvectVelocity.ScratchModule_06.Execute = Constant83;
Context.MapSimStage5_AdvectVelocity.ScratchModule_06.UseSolidVelocity = Constant84;
...
Context.MapSimStage6_ComputeDivergence.ScratchModule_04.UseFFT = Constant89;
...
Context.MapSimStage7_SolvePressure.Grid2D_PressureIteration.UseSolidVelocity = Constant91;
...
Context.MapSimStage8_SolvePressureASC40SinFFTinYASC41.Grid2D_ComputeFFT.XDirecton = Constant98;
bool Constant99 = false;
Context.MapSimStage8_SolvePressureASC40SinFFTinYASC41.Grid2D_ComputeFFT.Inverse = Constant99;
bool Constant100 = true;
Context.MapSimStage8_SolvePressureASC40SinFFTinYASC41.Grid2D_ComputeFFT.bPoissonSolver = Constant100;
...
Context.MapSimStage9_SolvePressureASC40SinFFTinXASC41.Grid2D_ComputeFFT001.XDirecton = Constant101;
bool Constant102 = false;
Context.MapSimStage9_SolvePressureASC40SinFFTinXASC41.Grid2D_ComputeFFT001.Inverse = Constant102;
bool Constant103 = true;
Context.MapSimStage9_SolvePressureASC40SinFFTinXASC41.Grid2D_ComputeFFT001.bPoissonSolver = Constant103;
...
Context.MapSimStage10_SolvePressureASC40InvSinFFTinXASC41.Grid2D_ComputeFFT002.Inverse = Constant104;
Context.MapSimStage10_SolvePressureASC40InvSinFFTinXASC41.Grid2D_ComputeFFT002.XDirecton = Constant105;
bool Constant106 = true;
Context.MapSimStage10_SolvePressureASC40InvSinFFTinXASC41.Grid2D_ComputeFFT002.bPoissonSolver = Constant106;
...
Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.Inverse = Constant107;
bool Constant108 = false;
Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.XDirecton = Constant108;
bool Constant109 = true;
Context.MapSimStage11_SolvePressureASC40InvSinFFTinYASC41.Grid2D_ComputeFFT003.bPoissonSolver = Constant109;
...
Context.MapSimStage12_ProjectPressure.ProjectPressureGrid2D.UseSolidVelocity = Constant110;
float Constant111 = 1;
Context.MapSimStage12_ProjectPressure.Local.ProjectPressureGrid2D.density = Constant111;
...
Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectScalar002.InterpolationMethod = Constant119;
float Constant120 = 1;
...
Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_AdvectScalar003.InterpolationMethod = Constant123;
float Constant124 = 1;
...
int Constant140 = 0;
int Constant141 = 1;
Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4.Channel = Constant138;
...
Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4001.Channel = Constant139;
...
Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4003.Channel = Constant140;
...
Context.MapSimStage13_AdvectScalarsandPostSim.MakeFloatFromVector4002.Channel = Constant141;
...
Context.MapSimStage13_AdvectScalarsandPostSim.Grid2D_Gas_SetRTValues.Enabled = Constant143;
...
NiagaraScript_485_Func_(In_SourceSpace, In_DestinationSpace, LocalToWorld_SelectResult, WorldToLocal_SelectResult, Constant17, NiagaraScript_485_Func_Output_bUseOriginal, NiagaraScript_485_Func_Output_OutTransform, NiagaraScript_485_Func_Output_LocalToWorld, Context);
float3 Result28 = mul(float4(In_Position,1.0),NiagaraScript_485_Func_Output_OutTransform).xyz;
...
NiagaraScript_484_Emitter_Localspace_false_Particle_Func_(GetPositionByIndex_Emitter_ParticleSource_AttributePositionOutput_Value, Constant7, Constant8, Constant9, Constant10, Constant11, Constant12, Constant13, NiagaraScript_484_Emitter_Localspace_false_Particle_Func_Output_Position, Context);
...
GetColorByIndex_Emitter_ParticleSource_Attributefluid_source_color(0, Result, GetColorByIndex_Emitter_ParticleSource_Attributefluid_source_colorOutput_Valid, GetColorByIndex_Emitter_ParticleSource_Attributefluid_source_colorOutput_Value);
...
float Constant9 = 0;
NiagaraScript_466_Func_(Context.Map.DissipateFloat.dt, Context.Map.DissipateFloat.DissipationRate, Constant9, Context.Map.DissipateFloat.FloatValue, NiagaraScript_466_Func_Output_DissipatedFloat, Context);
Context.Map.OUTPUT_VAR.DissipateFloat.DissipatedFloat = NiagaraScript_466_Func_Output_DissipatedFloat;
float Constant14 = 0;
NiagaraScript_466_Func_(Context.Map.DissipateFloat001.dt, Context.Map.DissipateFloat001.DissipationRate, Constant14, Context.Map.DissipateFloat001.FloatValue, NiagaraScript_466_Func_Output_DissipatedFloat1, Context);
Context.Map.OUTPUT_VAR.DissipateFloat001.DissipatedFloat = NiagaraScript_466_Func_Output_DissipatedFloat1;
...
NiagaraScript_471_Particle_Func_(Context.Map.MakeFloatFromVector4.Vector4, Context.Map.MakeFloatFromVector4.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput, Context);
NiagaraScript_471_Particle_Func_(Context.Map.MakeFloatFromVector4001.Vector4, Context.Map.MakeFloatFromVector4001.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput1, Context);
NiagaraScript_471_Particle_Func_(Context.Map.MakeFloatFromVector4003.Vector4, Context.Map.MakeFloatFromVector4003.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput2, Context);
NiagaraScript_471_Particle_Func_(Context.Map.MakeFloatFromVector4002.Vector4, Context.Map.MakeFloatFromVector4002.Channel, NiagaraScript_471_Particle_Func_Output_NewOutput3, Context);
...
SetRenderTargetValue_Emitter_SimRT_UEImpureCall(2, Context.Map.Grid2D_Gas_SetRTValues.Enabled, ExecutionIndexToGridIndex_Emitter_SimGridOutput_IndexX1, ExecutionIndexToGridIndex_Emitter_SimGridOutput_IndexY1, Output12);
int Constant = 1;
...
Context.Map.Grid2D_Gas_SetRTValues.Enabled = Constant24;
...
NiagaraScript_490_Particle_Func_(Context.Map.MakeFloatFromVector.VECTOR_VAR, Context.Map.MakeFloatFromVector.Channel, NiagaraScript_490_Particle_Func_Output_Float, Context);
NiagaraScript_490_Particle_Func_(Context.Map.MakeFloatFromVector001.VECTOR_VAR, Context.Map.MakeFloatFromVector001.Channel, NiagaraScript_490_Particle_Func_Output_Float1, Context);
NiagaraScript_490_Particle_Func_(Context.Map.MakeFloatFromVector002.VECTOR_VAR, Context.Map.MakeFloatFromVector002.Channel, NiagaraScript_490_Particle_Func_Output_Float2, Context);
float Constant18 = 0;
...
NiagaraScript_448_Particle_Func_(Constant26, Constant29, Constant30, NiagaraScript_448_Particle_Func_Output_Direction, NiagaraScript_448_Particle_Func_Output_Length, NiagaraScript_448_Particle_Func_Output_BelowThreshold, Context);
float3 Result17 = mul(float4(NiagaraScript_448_Particle_Func_Output_Direction,0.0),Context.Map.Grid2D_WindForce.WorldToLocal).xyz;
...
NiagaraScript_474_Func_(Context.Map.DissipateVector2D.dt, Context.Map.DissipateVector2D.DissipationRate, Context.Map.DissipateVector2D.VectorValue, NiagaraScript_474_Func_Output_DissipatedVector2D, Context);
Context.Map.OUTPUT_VAR.DissipateVector2D.DissipatedVector2D = NiagaraScript_474_Func_Output_DissipatedVector2D;
...
void NiagaraScript_406_Emitter_Determinism_false_Particle_Func_(int In_Seed, int In_Engine_System_TickCount, bool In_OverrideSeed, int In_Particles_UniqueID, int In_Emitter_RandomSeed, bool In_FixedOverrideSeed, int In_RandomnessMode, out NiagaraRandInfo Out_RandomInfo, out bool Out_UseDeterministicRandoms, inout FSimulationContext Context);
void NiagaraScript_412_Func_(float In_Min, float In_Max, int In_Seed, int In_RandomnessMode, bool In_OverrideSeed, out float Out_Result, inout FSimulationContext Context);
...
void NiagaraScript_405_Func_(float In_Min, float In_Max, int In_Seed, int In_RandomnessMode, bool In_OverrideSeed, bool In_FixedOverrideSeed, out float Out_Result, inout FSimulationContext Context);
void NiagaraScript_407_Func_(float In_Min, float In_Max, int In_Seed, int In_RandomnessMode, bool In_OverrideSeed, bool In_FixedOverrideSeed, out float Out_Result, inout FSimulationContext Context);
void NiagaraScript_409_Func_(float In_Min, float In_Max, int In_Seed, int In_RandomnessMode, bool In_OverrideSeed, bool In_FixedOverrideSeed, out float Out_Result, inout FSimulationContext Context);
void NiagaraScript_408_Func_(float In_Theta, float In_Radius, float In_Period, out float2 Out_XY, out float Out_X, out float Out_Y, out float2 Out_dXdY, out float Out_dX, out float Out_dY, inout FSimulationContext Context);
void NiagaraScript_373_Particle_Func_(float3 In_V, float3 In_Fallback, float In_Threshold, out float3 Out_Direction, out float Out_Length, out bool Out_BelowThreshold, inout FSimulationContext Context);
void NiagaraScript_404_Func_(float In_ConeAngle, float In_ConePointDistribution, bool In_EnableCurvature, float In_ConeCurvature, int In_Seed, int In_RandomnessMode, bool In_OverrideSeed, out float3 Out_Vector, out float3 Out_NormalizedVector, inout FSimulationContext Context);
void NiagaraScript_410_Func_(float In_INPUT_VAR, float In_InputLow, float In_InputHigh, float In_TargetLow, float In_TargetHigh, out float Out_Remapped, inout FSimulationContext Context);
void NiagaraScript_377_Func_(int In_SourceSpace, int In_DestinationSpace, float4x4 In_LocalToWorldTransform, float4x4 In_WorldToLocalTransform, bool In_bLocalSpace, out bool Out_bUseOriginal, out float4x4 Out_OutTransform, out bool Out_LocalToWorld, inout FSimulationContext Context);
...
void NiagaraScript_372_Func_(float3 In_From, float3 In_To, out float4 Out_NewOutput, inout FSimulationContext Context);
void NiagaraScript_369_Func_(float3 In_VECTOR_VAR, float4 In_Quaternion, out float3 Out_Vector, inout FSimulationContext Context);
void AddVelocityInCone_Emitter_Func_(inout FSimulationContext Context);
void NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, float3 In_RangeMin, float3 In_RangeMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out float3 Out_RandomValue, out bool Out_IsDeterministic, inout FSimulationContext Context);
void NiagaraScript_398_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(float In_InnerRadius, float In_OuterRadius, int In_Seed, out float3 Out_Ouput, inout FSimulationContext Context);
...
void NiagaraScript_419_Particle_Func_(float3 In_Velocity, float3 In_AdvectionVelocity, float In_InverseMass, float In_Drag, float In_DeltaTime, bool In_IgnoreMass, out float3 Out_Output, inout FSimulationContext Context);
void SolveForcesAndVelocity_Emitter_Func_(inout FSimulationContext Context);
void NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, float In_FloatMin, float In_FloatMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out float Out_RandomFloat, out bool Out_IsDeterministic, inout FSimulationContext Context);
...
int Constant37 = (0);
int Constant38 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
bool NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant31, Constant32, Constant33, Constant34, Constant35, Constant36, Constant37, Constant38, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
int Constant43 = (0);
...
int Constant49 = (0);
int Constant50 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
bool NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1;
NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant43, Constant44, Constant45, Constant46, Constant47, Constant48, Constant49, Constant50, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
...
int Constant63 = (0);
int Constant64 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2;
bool NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic2;
NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant57, Constant58, Constant59, Constant60, Constant61, Constant62, Constant63, Constant64, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic2, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2;
...
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo;
bool NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms;
NiagaraScript_406_Emitter_Determinism_false_Particle_Func_(In_Seed, Constant71, In_OverrideSeed, Constant73, Constant74, Constant75, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms, Context);
float Result7 = In_Max - In_Min;
int Seed1;
int Seed2;
int Seed3;
Seed1 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo.Seed1;
Seed2 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo.Seed2;
Seed3 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo.Seed3;
...
int Constant111 = (0);
int Constant112 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3;
bool NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic3;
NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant105, Constant106, Constant107, Constant108, Constant109, Constant110, Constant111, Constant112, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3, NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic3, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3;
int Constant127 = (0);
bool Constant128 = false;
int Constant129 = 0;
int Constant130 = (0);
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo1;
bool NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms1;
NiagaraScript_406_Emitter_Determinism_false_Particle_Func_(In_Seed, Constant127, In_OverrideSeed, Constant129, Constant130, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo1, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms1, Context);
float Result15 = In_Max - In_Min;
int Seed11;
int Seed21;
int Seed31;
Seed11 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo1.Seed1;
Seed21 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo1.Seed2;
Seed31 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo1.Seed3;
...
int Constant136 = 0;
int Constant137 = (0);
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo2;
bool NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms2;
NiagaraScript_406_Emitter_Determinism_false_Particle_Func_(In_Seed, Constant134, In_OverrideSeed, Constant136, Constant137, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo2, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms2, Context);
float Result19 = In_Max - In_Min;
int Seed12;
int Seed22;
int Seed32;
Seed12 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo2.Seed1;
Seed22 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo2.Seed2;
Seed32 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo2.Seed3;
...
int Constant146 = 0;
int Constant147 = (0);
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo3;
bool NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms3;
NiagaraScript_406_Emitter_Determinism_false_Particle_Func_(In_Seed, Constant144, In_OverrideSeed, Constant146, Constant147, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo3, NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_UseDeterministicRandoms3, Context);
float Result27 = In_Max - In_Min;
int Seed13;
int Seed23;
int Seed33;
Seed13 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo3.Seed1;
Seed23 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo3.Seed2;
Seed33 = NiagaraScript_406_Emitter_Determinism_false_Particle_Func_Output_RandomInfo3.Seed3;
...
float NiagaraScript_405_Func_Output_Result;
NiagaraScript_405_Func_(Constant124, Constant125, In_Seed, In_RandomnessMode, In_OverrideSeed, Constant126, NiagaraScript_405_Func_Output_Result, Context);
float Constant131 = 0;
float Constant132 = 1;
bool Constant133 = false;
float NiagaraScript_407_Func_Output_Result;
NiagaraScript_407_Func_(Constant131, Constant132, In_Seed, In_RandomnessMode, In_OverrideSeed, Constant133, NiagaraScript_407_Func_Output_Result, Context);
float Result23 = pow(max(0, NiagaraScript_407_Func_Output_Result),In_ConePointDistribution);
...
float NiagaraScript_409_Func_Output_Result;
NiagaraScript_409_Func_(Constant141, Constant142, In_Seed, In_RandomnessMode, In_OverrideSeed, Constant143, NiagaraScript_409_Func_Output_Result, Context);
float Constant148 = 0.0001;
float Constant149 = 10;
float Result31 = clamp(In_ConeCurvature,Constant148,Constant149);
float Result32 = pow(max(0, NiagaraScript_405_Func_Output_Result),Result31);
float float_IfResult;
float_IfResult = Result32;
float_IfResult = NiagaraScript_405_Func_Output_Result;
float2 NiagaraScript_408_Func_Output_XY;
float NiagaraScript_408_Func_Output_X;
float NiagaraScript_408_Func_Output_Y;
float2 NiagaraScript_408_Func_Output_dXdY;
float NiagaraScript_408_Func_Output_dX;
float NiagaraScript_408_Func_Output_dY;
NiagaraScript_408_Func_(NiagaraScript_409_Func_Output_Result, float_IfResult, Constant150, NiagaraScript_408_Func_Output_XY, NiagaraScript_408_Func_Output_X, NiagaraScript_408_Func_Output_Y, NiagaraScript_408_Func_Output_dXdY, NiagaraScript_408_Func_Output_dX, NiagaraScript_408_Func_Output_dY, Context);
float2 Result38 = Result26 * NiagaraScript_408_Func_Output_XY;
float2 Result39 = Result23 * Result38;
X = Result39.x;
Y = Result39.y;
Output12.x = NiagaraScript_405_Func_Output_Result;
Output12.y = X;
Output12.z = Y;
float3 Constant152 = float3(1,0,0);
float Constant153 = 1e-05;
float3 NiagaraScript_373_Particle_Func_Output_Direction;
float NiagaraScript_373_Particle_Func_Output_Length;
bool NiagaraScript_373_Particle_Func_Output_BelowThreshold;
NiagaraScript_373_Particle_Func_(Output12, Constant152, Constant153, NiagaraScript_373_Particle_Func_Output_Direction, NiagaraScript_373_Particle_Func_Output_Length, NiagaraScript_373_Particle_Func_Output_BelowThreshold, Context);
Out_Vector = Output12;
Out_NormalizedVector = NiagaraScript_373_Particle_Func_Output_Direction;
...
bool NiagaraScript_377_Func_Output_bUseOriginal;
float4x4 NiagaraScript_377_Func_Output_OutTransform;
bool NiagaraScript_377_Func_Output_LocalToWorld;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult, Matrix001_IfResult, Constant167, NiagaraScript_377_Func_Output_bUseOriginal, NiagaraScript_377_Func_Output_OutTransform, NiagaraScript_377_Func_Output_LocalToWorld, Context);
float3 Result85 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform).xyz;
...
float3 NiagaraScript_373_Particle_Func_Output_Direction1;
float NiagaraScript_373_Particle_Func_Output_Length1;
bool NiagaraScript_373_Particle_Func_Output_BelowThreshold1;
NiagaraScript_373_Particle_Func_(In_From, Constant174, Constant175, NiagaraScript_373_Particle_Func_Output_Direction1, NiagaraScript_373_Particle_Func_Output_Length1, NiagaraScript_373_Particle_Func_Output_BelowThreshold1, Context);
float3 Constant176 = float3(1,0,0);
float Constant177 = 1e-05;
float3 NiagaraScript_373_Particle_Func_Output_Direction2;
float NiagaraScript_373_Particle_Func_Output_Length2;
bool NiagaraScript_373_Particle_Func_Output_BelowThreshold2;
NiagaraScript_373_Particle_Func_(In_To, Constant176, Constant177, NiagaraScript_373_Particle_Func_Output_Direction2, NiagaraScript_373_Particle_Func_Output_Length2, NiagaraScript_373_Particle_Func_Output_BelowThreshold2, Context);
float4 CustomHlsl5A25A2A4455E3C692D3322A954DF887F_Func_Output_Result;
CustomHlsl5A25A2A4455E3C692D3322A954DF887F_Func_(NiagaraScript_373_Particle_Func_Output_Direction1, NiagaraScript_373_Particle_Func_Output_Direction2, CustomHlsl5A25A2A4455E3C692D3322A954DF887F_Func_Output_Result);
...
float3 NiagaraScript_404_Func_Output_Vector;
float3 NiagaraScript_404_Func_Output_NormalizedVector;
NiagaraScript_404_Func_(Result14, Constant117, Constant119, Constant120, Constant121, Constant122, Constant123, NiagaraScript_404_Func_Output_Vector, NiagaraScript_404_Func_Output_NormalizedVector, Context);
float3 Constant156 = float3(1,0,0);
float Result47 = dot(Constant156,NiagaraScript_404_Func_Output_NormalizedVector);
...
float Constant159 = 0;
float Constant160 = 1;
float NiagaraScript_410_Func_Output_Remapped;
NiagaraScript_410_Func_(Result47, Result49, Constant158, Constant159, Constant160, NiagaraScript_410_Func_Output_Remapped, Context);
float Constant161 = 0;
float Constant162 = 1;
float Result56 = clamp(NiagaraScript_410_Func_Output_Remapped,Constant161,Constant162);
Context.MapSpawn.Local.AddVelocityInCone.ConeVector = NiagaraScript_404_Func_Output_NormalizedVector;
...
float4 NiagaraScript_372_Func_Output_NewOutput;
NiagaraScript_372_Func_(Constant164, AddVelocityInCone_NF_TransformVector_Emitter_Func_Output_OutVector, NiagaraScript_372_Func_Output_NewOutput, Context);
float3 NiagaraScript_369_Func_Output_Vector;
NiagaraScript_369_Func_(Context.MapSpawn.Local.AddVelocityInCone.ConeVector, NiagaraScript_372_Func_Output_NewOutput, NiagaraScript_369_Func_Output_Vector, Context);
Context.MapSpawn.Local.AddVelocityInCone.ConeVector = NiagaraScript_369_Func_Output_Vector;
...
int Constant209 = (0);
int Constant210 = (0);
float3 NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue;
bool NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant201, Output14, Output15, In_Seed, Constant207, Constant208, Constant209, Constant210, NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
float Phi;
float CosASC40ThetaASC41;
float RASC943;
Phi = NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.x;
CosASC40ThetaASC41 = NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.y;
RASC943 = NiagaraScript_399_Particle_Particle_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.z;
...
bool NiagaraScript_377_Func_Output_bUseOriginal1;
float4x4 NiagaraScript_377_Func_Output_OutTransform1;
bool NiagaraScript_377_Func_Output_LocalToWorld1;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult2, Matrix001_IfResult1, Constant220, NiagaraScript_377_Func_Output_bUseOriginal1, NiagaraScript_377_Func_Output_OutTransform1, NiagaraScript_377_Func_Output_LocalToWorld1, Context);
float3 Result122 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform1).xyz;
...
bool NiagaraScript_377_Func_Output_bUseOriginal2;
float4x4 NiagaraScript_377_Func_Output_OutTransform2;
bool NiagaraScript_377_Func_Output_LocalToWorld2;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult3, Matrix001_IfResult2, Constant223, NiagaraScript_377_Func_Output_bUseOriginal2, NiagaraScript_377_Func_Output_OutTransform2, NiagaraScript_377_Func_Output_LocalToWorld2, Context);
float3 Result124 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform2).xyz;
...
bool NiagaraScript_377_Func_Output_bUseOriginal3;
float4x4 NiagaraScript_377_Func_Output_OutTransform3;
bool NiagaraScript_377_Func_Output_LocalToWorld3;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult4, Matrix001_IfResult3, Constant229, NiagaraScript_377_Func_Output_bUseOriginal3, NiagaraScript_377_Func_Output_OutTransform3, NiagaraScript_377_Func_Output_LocalToWorld3, Context);
float3 Result131 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform3).xyz;
...
float Constant200 = 1;
float3 NiagaraScript_398_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_Ouput;
NiagaraScript_398_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Result103, Constant200, Constant196, NiagaraScript_398_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_Ouput, Context);
Context.MapSpawn.Local.SphereLocation.SphereVector = NiagaraScript_398_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_Ouput;
...
bool NiagaraScript_377_Func_Output_bUseOriginal4;
float4x4 NiagaraScript_377_Func_Output_OutTransform4;
bool NiagaraScript_377_Func_Output_LocalToWorld4;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult5, Matrix001_IfResult4, Constant271, NiagaraScript_377_Func_Output_bUseOriginal4, NiagaraScript_377_Func_Output_OutTransform4, NiagaraScript_377_Func_Output_LocalToWorld4, Context);
float3 Result142 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform4).xyz;
...
bool NiagaraScript_377_Func_Output_bUseOriginal5;
float4x4 NiagaraScript_377_Func_Output_OutTransform5;
bool NiagaraScript_377_Func_Output_LocalToWorld5;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult6, Matrix001_IfResult5, Constant274, NiagaraScript_377_Func_Output_bUseOriginal5, NiagaraScript_377_Func_Output_OutTransform5, NiagaraScript_377_Func_Output_LocalToWorld5, Context);
float3 Result143 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform5).xyz;
...
bool NiagaraScript_377_Func_Output_bUseOriginal6;
float4x4 NiagaraScript_377_Func_Output_OutTransform6;
bool NiagaraScript_377_Func_Output_LocalToWorld6;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult7, Matrix001_IfResult6, Constant277, NiagaraScript_377_Func_Output_bUseOriginal6, NiagaraScript_377_Func_Output_OutTransform6, NiagaraScript_377_Func_Output_LocalToWorld6, Context);
float3 Result144 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform6).xyz;
...
bool NiagaraScript_377_Func_Output_bUseOriginal7;
float4x4 NiagaraScript_377_Func_Output_OutTransform7;
bool NiagaraScript_377_Func_Output_LocalToWorld7;
NiagaraScript_377_Func_(In_SourceSpace, In_DestinationSpace, Matrix_IfResult8, Matrix001_IfResult7, Constant280, NiagaraScript_377_Func_Output_bUseOriginal7, NiagaraScript_377_Func_Output_OutTransform7, NiagaraScript_377_Func_Output_LocalToWorld7, Context);
float3 Result145 = mul(float4(In_InVector,0.0),NiagaraScript_377_Func_Output_OutTransform7).xyz;
...
float3 NiagaraScript_419_Particle_Func_Output_Output;
NiagaraScript_419_Particle_Func_(Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity, Context.MapUpdate.Local.SolveForcesAndVelocity.AdvectionVelocity, Context.MapUpdate.Local.SolveForcesAndVelocity.InverseMass, Context.MapUpdate.Local.SolveForcesAndVelocity.PhysicsDrag, Context.MapUpdate.Local.SolveForcesAndVelocity.DeltaTime, Context.MapUpdate.Local.SolveForcesAndVelocity.DragIgnoreMass, NiagaraScript_419_Particle_Func_Output_Output, Context);
float3 Result178 = NiagaraScript_419_Particle_Func_Output_Output - Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity;
Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity = NiagaraScript_419_Particle_Func_Output_Output;
...
int Constant332 = (0);
int Constant333 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
bool NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant326, Constant327, Constant328, Constant329, Constant330, Constant331, Constant332, Constant333, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
int Constant339 = (0);
...
int Constant345 = (0);
int Constant346 = (0);
float NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
bool NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1;
NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant339, Constant340, Constant341, Constant342, Constant343, Constant344, Constant345, Constant346, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1, Context);
Out_UniformRangedFloat = NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
...
int Constant368 = (0);
int Constant369 = (0);
int NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue;
bool NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
bool NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsFixedRandomSeed;
NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant362, Constant363, Result192, Constant365, Constant366, Constant367, Constant368, Constant369, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsFixedRandomSeed, Context);
float4 Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArrayOutput_Value;
Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArray(NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArrayOutput_Value);
...
float NiagaraScript_412_Func_Output_Result;
NiagaraScript_412_Func_(Constant66, Constant67, Constant68, Constant69, Constant70, NiagaraScript_412_Func_Output_Result, Context);
Context.MapSpawn.InitializeParticle.MaterialRandom = NiagaraScript_412_Func_Output_Result;
...
int SpawnGroup;
float SpawnInterval;
void NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, float In_FloatMin, float In_FloatMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out float Out_RandomFloat, out bool Out_IsDeterministic, inout FSimulationContext Context);
void NiagaraScript_406_Emitter_Determinism_false_Func_(int In_Seed, int In_Engine_System_TickCount, bool In_OverrideSeed, int In_Particles_UniqueID, int In_Emitter_RandomSeed, bool In_FixedOverrideSeed, int In_RandomnessMode, out NiagaraRandInfo Out_RandomInfo, out bool Out_UseDeterministicRandoms, inout FSimulationContext Context);
void NiagaraScript_373_Func_(float3 In_V, float3 In_Fallback, float In_Threshold, out float3 Out_Direction, out float Out_Length, out bool Out_BelowThreshold, inout FSimulationContext Context);
void NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, float3 In_RangeMin, float3 In_RangeMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out float3 Out_RandomValue, out bool Out_IsDeterministic, inout FSimulationContext Context);
void NiagaraScript_419_Func_(float3 In_Velocity, float3 In_AdvectionVelocity, float In_InverseMass, float In_Drag, float In_DeltaTime, bool In_IgnoreMass, out float3 Out_Output, inout FSimulationContext Context);
void NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, float In_FloatMin, float In_FloatMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out float Out_RandomFloat, out bool Out_IsDeterministic, inout FSimulationContext Context);
void Length_Emitter_SelectLinearColorFromArray001_ColorSelectionArray(int In_InstanceData, out int Out_Num);
void NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(int In_Engine_System_RandomSeed, int In_IntegerMin, int In_IntegerMax, int In_Seed, int In_Engine_System_TickCount, int In_Particles_UniqueID, int In_Emitter_RandomSeed, int In_Engine_Emitter_InstanceSeed, out int Out_RandomValue, out bool Out_IsDeterministic, out bool Out_IsFixedRandomSeed, inout FSimulationContext Context);
void Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArray(int In_InstanceData, int In_Index, out float4 Out_Value);
float NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
bool NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant31, Constant32, Constant33, Constant34, Constant35, Constant36, Constant37, Constant38, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
float NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
bool NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1;
NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant43, Constant44, Constant45, Constant46, Constant47, Constant48, Constant49, Constant50, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
float NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2;
bool NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic2;
NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant57, Constant58, Constant59, Constant60, Constant61, Constant62, Constant63, Constant64, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic2, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat2;
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo;
bool NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms;
NiagaraScript_406_Emitter_Determinism_false_Func_(In_Seed, Constant71, In_OverrideSeed, Constant73, Constant74, Constant75, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo, NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms, Context);
Seed1 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo.Seed1;
Seed2 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo.Seed2;
Seed3 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo.Seed3;
float NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3;
bool NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic3;
NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant105, Constant106, Constant107, Constant108, Constant109, Constant110, Constant111, Constant112, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3, NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic3, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat3;
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo1;
bool NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms1;
NiagaraScript_406_Emitter_Determinism_false_Func_(In_Seed, Constant127, In_OverrideSeed, Constant129, Constant130, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo1, NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms1, Context);
Seed11 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo1.Seed1;
Seed21 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo1.Seed2;
Seed31 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo1.Seed3;
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo2;
bool NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms2;
NiagaraScript_406_Emitter_Determinism_false_Func_(In_Seed, Constant134, In_OverrideSeed, Constant136, Constant137, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo2, NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms2, Context);
Seed12 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo2.Seed1;
Seed22 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo2.Seed2;
Seed32 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo2.Seed3;
NiagaraRandInfo NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo3;
bool NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms3;
NiagaraScript_406_Emitter_Determinism_false_Func_(In_Seed, Constant144, In_OverrideSeed, Constant146, Constant147, In_FixedOverrideSeed, In_RandomnessMode, NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo3, NiagaraScript_406_Emitter_Determinism_false_Func_Output_UseDeterministicRandoms3, Context);
Seed13 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo3.Seed1;
Seed23 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo3.Seed2;
Seed33 = NiagaraScript_406_Emitter_Determinism_false_Func_Output_RandomInfo3.Seed3;
float3 NiagaraScript_373_Func_Output_Direction;
float NiagaraScript_373_Func_Output_Length;
bool NiagaraScript_373_Func_Output_BelowThreshold;
NiagaraScript_373_Func_(Output12, Constant152, Constant153, NiagaraScript_373_Func_Output_Direction, NiagaraScript_373_Func_Output_Length, NiagaraScript_373_Func_Output_BelowThreshold, Context);
Out_NormalizedVector = NiagaraScript_373_Func_Output_Direction;
float3 NiagaraScript_373_Func_Output_Direction1;
float NiagaraScript_373_Func_Output_Length1;
bool NiagaraScript_373_Func_Output_BelowThreshold1;
NiagaraScript_373_Func_(In_From, Constant174, Constant175, NiagaraScript_373_Func_Output_Direction1, NiagaraScript_373_Func_Output_Length1, NiagaraScript_373_Func_Output_BelowThreshold1, Context);
float3 NiagaraScript_373_Func_Output_Direction2;
float NiagaraScript_373_Func_Output_Length2;
bool NiagaraScript_373_Func_Output_BelowThreshold2;
NiagaraScript_373_Func_(In_To, Constant176, Constant177, NiagaraScript_373_Func_Output_Direction2, NiagaraScript_373_Func_Output_Length2, NiagaraScript_373_Func_Output_BelowThreshold2, Context);
CustomHlsl5A25A2A4455E3C692D3322A954DF887F_Func_(NiagaraScript_373_Func_Output_Direction1, NiagaraScript_373_Func_Output_Direction2, CustomHlsl5A25A2A4455E3C692D3322A954DF887F_Func_Output_Result);
float3 NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue;
bool NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant201, Output14, Output15, In_Seed, Constant207, Constant208, Constant209, Constant210, NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
Phi = NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.x;
CosASC40ThetaASC41 = NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.y;
RASC943 = NiagaraScript_399_ScriptUsage4_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue.z;
float3 NiagaraScript_419_Func_Output_Output;
NiagaraScript_419_Func_(Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity, Context.MapUpdate.Local.SolveForcesAndVelocity.AdvectionVelocity, Context.MapUpdate.Local.SolveForcesAndVelocity.InverseMass, Context.MapUpdate.Local.SolveForcesAndVelocity.PhysicsDrag, Context.MapUpdate.Local.SolveForcesAndVelocity.DeltaTime, Context.MapUpdate.Local.SolveForcesAndVelocity.DragIgnoreMass, NiagaraScript_419_Func_Output_Output, Context);
float3 Result178 = NiagaraScript_419_Func_Output_Output - Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity;
Context.MapUpdate.OUTPUT_VAR.SolveForcesAndVelocity.Velocity = NiagaraScript_419_Func_Output_Output;
float NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
bool NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant326, Constant327, Constant328, Constant329, Constant330, Constant331, Constant332, Constant333, NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat, NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat;
float NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
bool NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1;
NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant339, Constant340, Constant341, Constant342, Constant343, Constant344, Constant345, Constant346, NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1, NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1, Context);
Out_UniformRangedFloat = NiagaraScript_370_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1;
...
int NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue;
bool NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic;
bool NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsFixedRandomSeed;
NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant362, Constant363, Result192, Constant365, Constant366, Constant367, Constant368, Constant369, NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsFixedRandomSeed, Context);
Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArray(0, NiagaraScript_445_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArrayOutput_Value);
EnterStatScope(13 /**SpawnScript_1_1_Main*/);
...
EnterStatScope(14 /**SpawnScript_1_1_MapSpawnMain*/);
...
EnterStatScope(15 /**SpawnScript_1_1_MapUpdateMain*/);
...
NiagaraScript_419_Particle_Func_(Context.Map.OUTPUT_VAR.SolveForcesAndVelocity.Velocity, Context.Map.Local.SolveForcesAndVelocity.AdvectionVelocity, Context.Map.Local.SolveForcesAndVelocity.InverseMass, Context.Map.Local.SolveForcesAndVelocity.PhysicsDrag, Context.Map.Local.SolveForcesAndVelocity.DeltaTime, Context.Map.Local.SolveForcesAndVelocity.DragIgnoreMass, NiagaraScript_419_Particle_Func_Output_Output, Context);
float3 Result22 = NiagaraScript_419_Particle_Func_Output_Output - Context.Map.OUTPUT_VAR.SolveForcesAndVelocity.Velocity;
Context.Map.OUTPUT_VAR.SolveForcesAndVelocity.Velocity = NiagaraScript_419_Particle_Func_Output_Output;
...
int Constant41 = (0);
int Constant42 = (0);
NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant35, Constant36, Constant37, Constant38, Constant39, Constant40, Constant41, Constant42, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, Context);
int Constant48 = (0);
...
int Constant54 = (0);
int Constant55 = (0);
NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant48, Constant49, Constant50, Constant51, Constant52, Constant53, Constant54, Constant55, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomFloat1, NiagaraScript_370_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic1, Context);
...
int Constant77 = (0);
int Constant78 = (0);
NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_(Constant71, Constant72, Result36, Constant74, Constant75, Constant76, Constant77, Constant78, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsDeterministic, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_IsFixedRandomSeed, Context);
Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArray(0, NiagaraScript_445_Particle_Particle_ScriptUsage5_EvaluationType_NewEnumerator0_FixedRandomSeed_false_OverrideSeed_false_RandomnessMode_NewEnumerator0_Func_Output_RandomValue, Get_Emitter_SelectLinearColorFromArray001_ColorSelectionArrayOutput_Value);
...
EnterStatScope(7 /**UpdateScript_1_2_Main*/);
...
EnterStatScope(8 /**UpdateScript_1_2_MapMain*/);
