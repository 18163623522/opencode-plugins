...
GridCollection.SamplePreviousGridVector2DValue<Attribute="Velocity">(CurrUnit, Velocity);
float Scale = AdvectionVelocityMult * SimDt / FoamDx;
FoamGridCollection.SamplePreviousGridFloatValue<Attribute="Foam">(SampleUnit, OutGridVal);
